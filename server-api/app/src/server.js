...
const corsOptions = {
    origin: 'http://34.203.73.249:3000',
    credentials: true,
...
app.use((req, res, next) => {
    res.header('Access-Control-Allow-Origin', 'http://34.203.73.249:3000');
    ...
    require("../routes/kehadiran_route.js")(app)
...
// const IP = process.env.CLIENT_ORIGIN || "http://34.203.73.249:8080"
const PORT = process.env.PORT || 8080
app.listen(PORT, () => {
    console.log(`Server is Running on http://34.203.73.249:${PORT}`)
})
