...
function FormAddSetPresensi() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const responseKelas = await axios.get('http://34.203.73.249:8080/api/admin/kelas');
                setKelasList(responseKelas.data.data);

                // Fetch data for Mata Kuliah
                const responseMataKuliah = await axios.get('http://34.203.73.249:8080/api/admin/mata_kuliah');
    ...
    const saveSetPresensi = async(e) => {
        ...
        try {
            ...
            await axios.post('http://34.203.73.249:8080/api/admin/set_presensi/create', {
                tanggal : tanggal,
                jamMulai : jamMulai,
